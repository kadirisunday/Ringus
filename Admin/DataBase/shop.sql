...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  CONSTRAINT `member_1` FOREIGN KEY (`Member_ID`) REFERENCES `vendors` (`VendorsID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `vendors` (
  `VendorsID` int(11) NOT NULL AUTO_INCREMENT COMMENT 'To Identify Vendors',
...
--
-- Dumping data for table `vendorss`
--

INSERT INTO `vendorss` (`UserID`, `Username`, `Password`, `Email`, `FullName`, `GroupID`, `TrustStatus`, `RegStatus`, `Date`, `avatar`) VALUES
